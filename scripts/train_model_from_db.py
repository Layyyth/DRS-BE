...
food_allergens_df = pd.read_csv('scripts/finalAllergens.csv')
meals_df = pd.read_csv('scripts/finalMeals.csv')
...
model_filename = f"model/trained-models/mealPredictingModel_{current_date}.pkl"
